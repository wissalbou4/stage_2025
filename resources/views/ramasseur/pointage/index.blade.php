...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ route('ramasseur.pointage.show') }}" method="GET" class="card p-3 mb-4">
        ...
        <div class="col-md-6">
            ...
            <form action="{{ route('ramasseur.pointage.store') }}" method="POST">
                @csrf
        ...
        <div class="card p-3 mb-4">
            ...
            <form action="{{ route('ramasseur.pointage.user.update_etat') }}" method="POST">
                @csrf
